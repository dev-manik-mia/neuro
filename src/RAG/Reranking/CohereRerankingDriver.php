...
namespace Manik\Neuro\RAG\Reranking;
...
class CohereRerankingDriver
{
    ...
    public function __construct(
        ...
        $this->apiKey = $apiKey ?: (string) config('ai.embedding.cohere.api_key', '');
        $this->baseUrl = $baseUrl ?: (string) config('ai.embedding.cohere.base_url', 'https://api.cohere.com/v1');
        $this->model = (string) config('ai.embedding.cohere.model', 'rerank-english-v3.0');
    }
